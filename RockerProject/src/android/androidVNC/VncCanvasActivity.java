...
public class VncCanvasActivity extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		mySurfaceView = (MySurfaceView) findViewById(R.id.rock);
		...
		MyConnect connect = new MyConnect(ip, 15000);
		Thread xiancheng = new Thread(connect);
		xiancheng.start();
			...
			DirectionMonitor dirmon = new DirectionMonitor(mySurfaceView, connect);
			Thread th = new Thread(dirmon);
			th.start();
			Log.e("aa", "ok");
		
//		Thread th = new Thread(mySurfaceView);
//		th.start();
